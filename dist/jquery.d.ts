...
interface JQueryDeferred<T> extends JQueryGenericPromise<T> {
     ...
     * @param {def.jquery.JQueryDeferred.ArrayJQueryPromiseCallbackAny[]} alwaysCallbacksN
     * @return {*}
     */
     ...
     * @param {*} doneCallback1
     * @param {def.jquery.JQueryDeferred.ArrayJQueryPromiseCallbackT<T>[]} doneCallbackN
     * @return {*}
     */
     ...
     * @param {*} failCallback1
     * @param {def.jquery.JQueryDeferred.ArrayJQueryPromiseCallbackAny[]} failCallbacksN
     * @return {*}
     */
     ...
     * @param {def.jquery.JQueryDeferred.ArrayJQueryPromiseCallbackAny[]} progressCallbackN
     * @return {*}
     */
     ...
     * 
     * @param {java.lang.Object[]} args Optional arguments that are passed to the progressCallbacks.
     * @param {*} value
     * @return {*}
     */
     ...
     * 
     * @param {java.lang.Object[]} args Optional arguments that are passed to the failCallbacks.
     * @param {*} value
     * @return {*}
     */
     ...
     * @param {java.lang.Object[]} args Optional subsequent arguments that are passed to the doneCallbacks.
     * @return {*}
     */
     ...
     * @param alwaysCallbacks1 A function, or array of functions, that is called when the Deferred is resolved or rejected.
     * @param alwaysCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.
     * @param {def.jquery.JQueryPromiseCallback<?>[]} alwaysCallback1
     * @param {def.jquery.JQueryDeferred.ArrayJQueryPromiseCallbackAnys[]} alwaysCallbacksN
     * @return {*}
     */
    always(alwaysCallback1: JQueryPromiseCallback<any>[], ...alwaysCallbacksN: any[]): JQueryDeferred<T>;
     ...
     * @param doneCallbacks1 A function, or array of functions, that are called when the Deferred is resolved.
     * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
     * @param {def.jquery.JQueryPromiseCallback<T>[]} doneCallback1
     * @param {def.jquery.JQueryDeferred.ArrayJQueryPromiseCallbackTs<T>[]} doneCallbackN
     * @return {*}
     */
    done(doneCallback1: JQueryPromiseCallback<T>[], ...doneCallbackN: any[]): JQueryDeferred<T>;
     ...
     * @param failCallbacks1 A function, or array of functions, that are called when the Deferred is rejected.
     * @param failCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is rejected.
     * @param {def.jquery.JQueryPromiseCallback<?>[]} failCallback1
     * @param {def.jquery.JQueryDeferred.ArrayJQueryPromiseCallbackAnys[]} failCallbacksN
     * @return {*}
     */
    fail(failCallback1: JQueryPromiseCallback<any>[], ...failCallbacksN: any[]): JQueryDeferred<T>;
     ...
     * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
     * @param {*} progressCallback1
     * @param {def.jquery.JQueryDeferred.ArrayJQueryPromiseCallbackAnys[]} progressCallbackN
     * @return {*}
     */
    progress(progressCallback1: JQueryPromiseCallback<any>, ...progressCallbackN: any[]): JQueryDeferred<T>;
     ...
     * 
     * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
     * @param {def.jquery.JQueryPromiseCallback<?>[]} progressCallback1
     * @param {def.jquery.JQueryDeferred.ArrayJQueryPromiseCallbackAnys[]} progressCallbackN
     * @return {*}
     */
    progress(progressCallback1: JQueryPromiseCallback<any>[], ...progressCallbackN: any[]): JQueryDeferred<T>;
     ...
     * @param alwaysCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.
     * @param {*} alwaysCallback1
     * @param {def.jquery.JQueryPromiseCallback<?>[]} alwaysCallbacksN
     * @return {*}
     */
     ...
     * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
     * @param {*} doneCallback1
     * @param {def.jquery.JQueryPromiseCallback<T>[]} doneCallbackN
     * @return {*}
     */
     ...
     * @param failCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is rejected.
     * @param {*} failCallback1
     * @param {def.jquery.JQueryPromiseCallback<?>[]} failCallbacksN
     * @return {*}
     */
     ...
     * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
     * @param {*} progressCallback1
     * @param {def.jquery.JQueryPromiseCallback<?>[]} progressCallbackN
     * @return {*}
     */
...
interface JQueryCallback {
     ...
     * Add a callback or a collection of callbacks to a callback list.
     * 
     * @param {def.js.Function[]} callbacks A function, or array of functions, that are to be added to the callback list.
     * @return {*}
     */
    add(callbacks: Function[]): JQueryCallback;
     ...
     * 
     * @param {java.lang.Object[]} arguments The argument or list of arguments to pass back to the callback list.
     * @return {*}
     */
     ...
     * Remove a callback or a collection of callbacks from a callback list.
     * 
     * @param {def.js.Function[]} callbacks A function, or array of functions, that are to be removed from the callback list.
     * @return {*}
     */
    remove(callbacks: Function[]): JQueryCallback;
...
interface JQuery {
     ...
     * @return {def.jquery.JQuerySerializeArrayElement[]}
     */
     ...
     * Remove a previously-stored piece of data.
     * 
     * @param {java.lang.String[]} list An array of strings naming the pieces of data to delete.
     * @return {*}
     */
     ...
     * @param {java.lang.Object[]} extraParameters Additional parameters to pass along to the event handler.
     * @return {*}
     */
     ...
     * 
     * @param {string} eventType A string containing a JavaScript event type, such as click or submit.
     * @param {java.lang.Object[]} extraParameters An array of additional parameters to pass along to the event handler.
     * @return {*}
     */
     ...
     * 
     * @param {java.lang.Object[]} elements An array of elements to push onto the stack and make into a new jQuery object.
     * @return {*}
     */
     ...
     * @param {java.lang.Object[]} arguments The arguments that were passed in to the jQuery method (for serialization).
     * @return {*}
     */
     ...
     * @param {*} content1
     * @param {java.lang.Object[]} content2
     * @return {*}
     */
     ...
     * Add elements to the set of matched elements.
     * 
     * @param {def.dom.Element[]} elements One or more elements to add to the set of matched elements.
     * @return {*}
     */
     ...
     * 
     * @param {def.js.Function[]} newQueue An array of functions to replace the current queue contents.
     * @return {*}
     */
     ...
     * Set the value of each element in the set of matched elements.
     * 
     * @param {java.lang.String[]} value A string of text, an array of strings or number corresponding to the value of each matched element to set as selected/checked.
     * @return {*}
     */
    val(value: string[]): JQuery;
     ...
     * Remove elements from the set of matched elements.
     * 
     * @param {def.dom.Element[]} elements One or more DOM elements to remove from the matched set.
     * @return {*}
     */
    not(elements: Element[]): JQuery;
...
interface JQueryXHR extends XMLHttpRequest {
     ...
     * @param alwaysCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.
     * @param {*} alwaysCallback1
     * @param {def.jquery.JQueryXHR.ArrayJQueryPromiseCallbackAny[]} alwaysCallbacksN
     * @return {*}
     */
     ...
     * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
     * @param {*} doneCallback1
     * @param {def.jquery.JQueryXHR.ArrayJQueryPromiseCallbackAny[]} doneCallbackN
     * @return {*}
     */
     ...
     * @param failCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is rejected.
     * @param {*} failCallback1
     * @param {def.jquery.JQueryXHR.ArrayJQueryPromiseCallbackAny[]} failCallbacksN
     * @return {*}
     */
     ...
     * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
     * @param {*} progressCallback1
     * @param {def.jquery.JQueryXHR.ArrayJQueryPromiseCallbackAny[]} progressCallbackN
     * @return {*}
     */
     ...
     * @param alwaysCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.
     * @param {*} alwaysCallback1
     * @param {def.jquery.JQueryXHR.ArrayJQueryPromiseCallbackAnys[]} alwaysCallbacksN
     * @return {*}
     */
    always(alwaysCallback1: JQueryPromiseCallback<any>, ...alwaysCallbacksN: any[]): JQueryPromise<any>;
     ...
     * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
     * @param {*} doneCallback1
     * @param {def.jquery.JQueryXHR.ArrayJQueryPromiseCallbackAnys[]} doneCallbackN
     * @return {*}
     */
    done(doneCallback1: JQueryPromiseCallback<any>, ...doneCallbackN: any[]): JQueryPromise<any>;
     ...
     * @param doneCallbacks1 A function, or array of functions, that are called when the Deferred is resolved.
     * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
     * @param {def.jquery.JQueryPromiseCallback<?>[]} doneCallback1
     * @param {def.jquery.JQueryXHR.ArrayJQueryPromiseCallbackAnys[]} doneCallbackN
     * @return {*}
     */
    done(doneCallback1: JQueryPromiseCallback<any>[], ...doneCallbackN: any[]): JQueryPromise<any>;
     ...
     * @param failCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is rejected.
     * @param {*} failCallback1
     * @param {def.jquery.JQueryXHR.ArrayJQueryPromiseCallbackAnys[]} failCallbacksN
     * @return {*}
     */
    fail(failCallback1: JQueryPromiseCallback<any>, ...failCallbacksN: any[]): JQueryPromise<any>;
     ...
     * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
     * @param {def.jquery.JQueryPromiseCallback<?>[]} progressCallback1
     * @param {def.jquery.JQueryXHR.ArrayJQueryPromiseCallbackAnys[]} progressCallbackN
     * @return {*}
     */
    progress(progressCallback1: JQueryPromiseCallback<any>[], ...progressCallbackN: any[]): JQueryPromise<any>;
     ...
     * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
     * @param {*} doneCallback1
     * @param {def.jquery.JQueryPromiseCallback<?>[]} doneCallbackN
     * @return {*}
     */
...
interface JQueryPromise<T> extends JQueryGenericPromise<T> {
     ...
     * @param alwaysCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.
     * @param {*} alwaysCallback1
     * @param {def.jquery.JQueryPromise.ArrayJQueryPromiseCallbackAny[]} alwaysCallbacksN
     * @return {*}
     */
     ...
     * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
     * @param {*} doneCallback1
     * @param {def.jquery.JQueryPromise.ArrayJQueryPromiseCallbackT<T>[]} doneCallbackN
     * @return {*}
     */
     ...
     * @param failCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is rejected.
     * @param {*} failCallback1
     * @param {def.jquery.JQueryPromise.ArrayJQueryPromiseCallbackAny[]} failCallbacksN
     * @return {*}
     */
     ...
     * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
     * @param {*} progressCallback1
     * @param {def.jquery.JQueryPromise.ArrayJQueryPromiseCallbackAny[]} progressCallbackN
     * @return {*}
     */
     ...
     * @param alwaysCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.
     * @param {*} alwaysCallback1
     * @param {def.jquery.JQueryPromise.ArrayJQueryPromiseCallbackAnys[]} alwaysCallbacksN
     * @return {*}
     */
    always(alwaysCallback1: JQueryPromiseCallback<any>, ...alwaysCallbacksN: any[]): JQueryPromise<T>;
     ...
     * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
     * @param {def.jquery.JQueryPromiseCallback<T>[]} doneCallback1
     * @param {def.jquery.JQueryPromise.ArrayJQueryPromiseCallbackTs<T>[]} doneCallbackN
     * @return {*}
     */
    done(doneCallback1: JQueryPromiseCallback<T>[], ...doneCallbackN: any[]): JQueryPromise<T>;
     ...
     * @param failCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is rejected.
     * @param {*} failCallback1
     * @param {def.jquery.JQueryPromise.ArrayJQueryPromiseCallbackAnys[]} failCallbacksN
     * @return {*}
     */
    fail(failCallback1: JQueryPromiseCallback<any>, ...failCallbacksN: any[]): JQueryPromise<T>;
     ...
     * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
     * @param {*} progressCallback1
     * @param {def.jquery.JQueryPromise.ArrayJQueryPromiseCallbackAnys[]} progressCallbackN
     * @return {*}
     */
    progress(progressCallback1: JQueryPromiseCallback<any>, ...progressCallbackN: any[]): JQueryPromise<T>;
...
interface JQueryStatic {
     ...
     * Accepts a string containing a CSS selector which is then used to match a set of elements.
     * 
     * @param {def.dom.Element[]} elementArray An array containing a set of DOM elements to wrap in a jQuery object.
     * @return {*}
     */
     ...
     * 
     * @param {def.jquery.JQueryStatic.ArrayT<T>[]} deferreds One or more Deferred objects, or plain JavaScript objects.
     * @return {*}
     */
     ...
     * @param {java.lang.Object[]} additionalArguments Any number of arguments to be passed to the function referenced in the function argument.
     * @return {*}
     */
     ...
     * @param {java.lang.Object[]} additionalArguments Any number of arguments to be passed to the function named in the name argument.
     * @return {*}
     */
     ...
     * 
     * @param {T[]} collection The object or array to iterate over.
     ...
     * @param {java.lang.Object[]} objectN Additional objects containing properties to merge in.
     * @return {*}
     */
     ...
     * @param {T[]} array An array through which to search.
     ...
     * 
     * @param {T[]} array The Array to translate.
     ...
     * 
     * @param {T[]} first The first array to merge, the elements of second added.
     * @param {T[]} second The second array to merge into the first, unaltered.
     * @return {T[]}
     */
     ...
     * 
     * @param {def.dom.Element[]} array The Array of DOM elements.
     * @return {def.dom.Element[]}
     */
     ...
     * Provides a way to execute callback functions based on one or more objects, usually Deferred objects that represent asynchronous events.
     * 
     * @param {def.jquery.JQueryStatic.ArrayJQueryPromiseT<T>[]} deferreds One or more Deferred objects, or plain JavaScript objects.
     * @return {*}
     */
    when<T>(...deferreds: any[]): JQueryPromise<T>;
     ...
     * Provides a way to execute callback functions based on one or more objects, usually Deferred objects that represent asynchronous events.
     * 
     * @param {T[]} deferreds One or more Deferred objects, or plain JavaScript objects.
     * @return {*}
     */
     ...
     * Provides a way to execute callback functions based on one or more objects, usually Deferred objects that represent asynchronous events.
     * 
     * @param {def.jquery.JQueryPromise<T>[]} deferreds One or more Deferred objects, or plain JavaScript objects.
     * @return {*}
     */
